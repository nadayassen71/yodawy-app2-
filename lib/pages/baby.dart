...
class baby extends StatelessWidget {
  final value;
  final String value2,a1,a2,a3,a4,a5,b,b1,b2,b3,b4,b5,c,c1,c2,c3,c4,c5,d,d1,d2,d3,d4,d5,e,e1,e2,e3,e4,e5,f,p1,p2,p3,p4,p5,p6;

  baby ({this.value, required this.value2,required this.a1,required this.a2,required this.a3,required this.a4,required this.a5,required this.b,required this.b1,required this.b2
    ...
    ,required this.e2,required this.e3,required this.e4,required this.e5,required this.f,required this.p1,required this.p2,required this.p3,
    required this.p4,required this.p5,required this.p6});
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Padding(padding: EdgeInsets.only(top: 20)),
          Container(
            child: Image.network(listt['off'].toString(),width: 140,height: 140,),
          ...
          Padding(padding: EdgeInsets.only(top: 10)),
          parts(context,listt['p7'].toString(),listt['p7n'].toString(),listt['p8'].toString(),listt['p8n'].toString()),
          Padding(padding: EdgeInsets.only(top: 10)),
          parts(context,listt['p9'].toString(),listt['p9n'].toString(),listt['p10'].toString(),listt['p10n'].toString()),
